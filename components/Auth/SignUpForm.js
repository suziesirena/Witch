    ...
    return (
      <div style={{margin:10}}>
        <form action="/" onSubmit={this.props.onSubmit}>
          ...
          {/* <div className="haveAccount">Already have an account? <Link to={'/login'}>Log in</Link></div> */}
          ...
          <div className="field-line">
            <TextField floatingLabelText="Password" type="password" name="password" onChange={this.props.onChange} errorText={this.props.errors.password} value={this.props.user.password} />
          </div>
